...
vignette: >
  ...
  %\VignetteDepends{data.table, ggplot2, grDevices, igraph, RColorBrewer, quickPlot, stats}
...
Plotting requirements for many other uses, including simulation modeling, are different.
...
The `Plot` function is therefore intended to be used as a way to interact visually especially during development of rapid, repeated visualizations, such as simulation modeling.
